...
public class BillForm extends JFrame {
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			...
			lblNewLabel_1.setBounds(23, 42, 106, 34);
		}
	...
	private JLabel getLblNewLabel_1_1() {
		if (lblNewLabel_1_1 == null) {
			...
			lblNewLabel_1_1.setBounds(23, 86, 146, 34);
		}
	...
	private JLabel getLblNewLabel_1_2() {
		if (lblNewLabel_1_2 == null) {
			...
			lblNewLabel_1_2.setBounds(23, 131, 106, 34);
		}
	...
	private JLabel getLblNewLabel_1_3() {
		if (lblNewLabel_1_3 == null) {
			...
			lblNewLabel_1_3.setBounds(23, 176, 106, 34);
		}
	...
	private JLabel getLblNewLabel_1_4() {
		if (lblNewLabel_1_4 == null) {
			...
			lblNewLabel_1_4.setBounds(23, 229, 106, 34);
		}
	...
	private JLabel getLblNewLabel_1_5() {
		if (lblNewLabel_1_5 == null) {
			...
			lblNewLabel_1_5.setBounds(23, 274, 106, 34);
		}
	...
	private JLabel getLblNewLabel_1_6() {
		if (lblNewLabel_1_6 == null) {
			...
			lblNewLabel_1_6.setBounds(23, 319, 106, 34);
		}
	...
	private JTextField getBillnoFld() {
		if (billnoFld == null) {
			...
			billnoFld.setBounds(179, 42, 218, 34);
	...
	private JTextField getCustomernameFld() {
		if (customernameFld == null) {
			...
			customernameFld.setBounds(179, 86, 218, 34);
		}
	...
	private JComboBox getProductidCombo() {
		if (productidCombo == null) {
			...
			productidCombo.setBounds(179, 131, 218, 34);
		}
	...
	private JTextField getNameFld() {
		if (nameFld == null) {
			...
			nameFld.setBounds(179, 176, 218, 34);
		}
		return nameFld;
	}
	private JTextField getMrpFld() {
		if (mrpFld == null) {
			...
			mrpFld.setBounds(179, 221, 218, 34);
		}
		return mrpFld;
	}
	private JTextField getQuantityFld() {
		if (quantityFld == null) {
			...
			quantityFld.setBounds(179, 269, 218, 34);
		}
		return quantityFld;
	}
	private JTextField getDiscountFld() {
		if (discountFld == null) {
			...
			discountFld.setBounds(179, 314, 218, 34);
		}
		return discountFld;
	}
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setBounds(78, 411, 106, 44);
		}
		return btnNewButton;
	}
	private JButton getBtnRemove() {
		if (btnRemove == null) {
			...
			btnRemove.setBounds(227, 411, 106, 44);
		}
		return btnRemove;
	}
